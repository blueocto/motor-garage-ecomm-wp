        ...
        <div>
            <div class="sbc-extpp-top sbc-fs">
                <div class="sbc-extpp-info">
                    ...
                    <div v-if="extensionsPopup[viewsActive.extensionsPopupElement].popupContentBtn && !sbyLicenseNoticeActive" v-html="extensionsPopup[viewsActive.extensionsPopupElement].popupContentBtn"></div>
                </div>
