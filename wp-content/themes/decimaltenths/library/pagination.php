	...
	function octopress_pagination() {
        ...
        if ( $paginate_links ) {
            ...
            $preg_replace = [
                ...
                '<li><a class="next page-numbers" href="$1" aria-label="Next page">→', // '$1' Outputs backreference href value
            ...
            $paginate_links = '<nav class="woocommerce-pagination" aria-label="Pagination">' . $paginate_links . '</nav>';
