...
<main id="main" class="main">
    ...
    <section class="hero-intro">
        <div class="row">
            <div class="column small-12 large-7 hero-intro--image">&nbsp;</div>
            <div class="column small-12 large-5 hero-intro--content">
                <h1><span class="small-h">Welcome to</span> Decimal Tenths</h1>
                <p class="h6">Lorem ipsum dolor sit amet, consectetur adipiscing elit fuis  ultrices nunc. Cras id quam non odio egestas cursus nisi. Suspendisse potenti norbi a tristique.</p>
